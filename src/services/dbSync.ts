...
export const SEED_DATA: { accounts: Account[]; trades: Trade[] } = {
  ...
  trades: [
    ...
    },
    {
      ...
      rating: 5,
      checklistPassed: true,
      preTradeNotes: "Bounce off off 10am open, valid bias flip. Just didn't push through.",
      postTradeNotes: ""
    },
    {
      ...
      rating: 5,
      checklistPassed: true,
      preTradeNotes: "Good long setup, same as Gatie.",
      postTradeNotes: "Price didn't go where I expected, and I chased an entry."
    },
    {
